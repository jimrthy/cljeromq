...
(let [url "tcp://127.0.0.1:2102"]
  ;; A different branch had a comment that I've verified that this absolutely
  ;; works in python.
  ;; But I really couldn't have, because of the GIL.
  ;; TODO: Verify in another language that supports "real" threads
